        ...
        <div className="about-area pd-t10 pd-b10">
          <Container>
            <div className="elementor-widget-container">
              <h3 className="elementor-headline e-animated mr-t10">
                <span className="elementor-headline-plain-text elementor-headline-text-wrapper mr-r30">
                  Welcome
                </span>
                <span className="elementor-headline-dynamic-wrapper elementor-headline-text-wrapper">
                  <span className="elementor-headline-dynamic-text elementor-headline-text-active mr-r10">
                    Rockstars
                  </span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
